class_name PhotoGrader
extends Node
## Grades a photo based on various parameters. Needs improvement.

@export_category("Settings")
@export_range(0.01,1) var distance_falloff: float = 0.1
...
func _on_photo_taker_take_photo(_texture):
...
# Score based on what the subject is doing.
